-- STEP 6: MART - UPDATE PRIORIRY MART 

-- UPDATE DE TO PRIORITY 1
SELECT '=== UPDATING DE TO PRIORITY 1 ===' AS info;
UPDATE priority_mart.priority_roles
SET priority_lvl = 1 
WHERE role_name = 'Data Engineer';

-- ADD DATA SCIENTIST AS LEVEL 2
...
-- CREATE TEMP TABLE
SELECT '=== CREATE TEMP TABLE FOR PRIORITY MART ===' AS info;
...
-- MERGE INTO
SELECT '=== UPDATING PRIORITY_JOBS_SNAPSHOT PRIORITY MART ===' AS info;
...
-- FINAL
SELECT '=== FINAL CHECK QUERY ===' AS info;
SELECT
    job_title_short,
    COUNT(*) AS job_count,
